...
const Cont = () => {
  ...
  return (
    <div>
        <h1 style={h1Style}>PROGRAMES OFFERED</h1>
        <hr></hr>
  <h2 style={h2Style}>UNDERGRADUATE PROGRAMMES</h2>
      ...
      <table style={tableStyle}>
          ...
          <div>
            <h2 style={h2Style}>POSTGRADUATE PROGRAMMES</h2>
            <table style={tableStyle}>
          <thead>
              <tr>
                  <th style={thStyle}>S.NO</th>
          ...
          <tr>
              ...
              <div>
            <h2 style={h2Style}>Ph.D RESEARCH PROGRAMMES</h2>
            <table style={tableStyle}>
          <thead>
              <tr>
                  <th style={thStyle}>S.NO</th>
          ...
          <div>
            <h1 style={h1Style}>ELIGIBILITY FOR VARIOUS COURSES</h1>
            <hr></hr>
            <h2 style={h2Style}>HSC(ACADEMIC)</h2>
            <table style={tableStyle}>
          <thead>
              <tr>
                  <th style={thStyle}>S.NO</th>
          ...
          <tr>
              ...
              <div>
            <h2 style={h2Style}>HSC(VOCATIONAL)</h2>
            <table style={tableStyle}>
          <thead>
              <tr>
                  <th style={thStyle}>S.NO</th>
